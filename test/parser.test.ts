...
// import { parseJsonTree } from "../src/parsers/json-tree";
// import { parseFlatSpans } from "../src/parsers/json-flat";
// import { parseOtel } from "../src/parsers/otel";
// import { autoDetect } from "../src/parsers/index";
...
//     const t = autoDetect({
//       resourceSpans: [
//         { scopeSpans: [{ spans: [{ spanId: "s1", parentSpanId: "", name: "root", attributes: [] }] }] },
//       ],
//     });
//     expect(t.children.length).toBeGreaterThanOrEqual(1);
//   });
...
//     const { runDiff } = await import("./helpers");
//     const base = {
//       id: "root",
//       type: "span",
//       label: "root",
